...
<style type="text/css">
	@page { size: auto;  margin: 33mm; margin-right: -30px; margin-left: -30px;}
@media print {
    a[href]:after {
...
<div class="container-fluid">
	<?php $sql="SELECT count(*) from form WHERE reg_no=:reg_no"; 
    	 $stmt = $db->prepare($sql);
  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         $sql="SELECT * from form WHERE reg_no=:reg_no"; 
         $stmt = $db->prepare($sql);
           $stmt->bindParam(':reg_no', $reg_no, PDO::PARAM_STR);
           $stmt->execute();
           $rows=$stmt->fetchall();
...
<div class="row">
          <div class="col-2">
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvY56BfqwOwLRIlc8msEqDhH7ylbFD1tv54t-Y_T0j&s" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading"> Education Through Self-Help is Our Motto"-Karmaveer</div>
     <p class="sub-heading"> Rayat Shikshan Sanstha's<br>ARTS|SCIENCE|COMMERCE|<br>(Re-Accredited by NAAC with 'A' Grade with CGPA of 3.09)
        <br>(Affilated to Savitribai Phule Pune University,Pune I.D.No.PU/PN/SC/069/1986(Estd.1986)
         Princicpal-Dr.GAIKWAD NANASAHEB SURYABHAN M.Sc.Ph.D.</p>
      <div class="address">S.M JOSHI COLLEGE, HADAPSAR,PUNE-28
</div>
         <p class="email"> EMAIL: rayatsmjoshicollege@rediffmail.com<br>
    smjoshicollege@gmail.com</p>
          </div>
  ...
  <div class="col-sm-12" style="text-align:center; border: 1px solid black; padding-bottom: 20px;">
   <h3> <u>Admission form 2023</u></h3>
  </div>
  <div class="col-sm-4">
  </div>
  <br>
